...
const home = () => {
  return (
    <div>
      ...
      <Card img="http://www.aibifitness.com/commercial/wp-content/uploads/2016/07/user-5121.png" to="/user" linkText="User" description="All important data about you (safely saved)" />
      <br />
      <FooterStyle>Football data provided by the Football-Data.org API</FooterStyle>
    </div>
  )
}
